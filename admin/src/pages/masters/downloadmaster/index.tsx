...
const DownloadMaster: React.FC = () => {
        ...
        try {
            ...
            if (formData.image && formData.title && formData.description) {
                ...
                if (file && file.files && file.files[0]) {
                    ...
                    await axios.post("http://localhost:5000/downloadmasterupload", formData);
                }
                ...
                if (formData.id) {
                    const responseupdatedata = await axios.put(`http://localhost:5000/downloadmaster/${formData.id}`, formData);
                    console.log(responseupdatedata.data);
                } else {
                    const responseinsertdata = await axios.post("http://localhost:5000/downloadmaster", formData);
    ...
    const fetchWorkingStepData = async () => {
        try {
            const response = await axios.get('http://localhost:5000/downloadmaster');
                        ...
                        <form id="workingstepmasterForm" onSubmit={handleSubmit}>
                            ...
                            <div className="container-fluid rounded bg-white py-3">
                                ...
                                <div className='row'>
                                    ...
                                    <div className="col-3">
                                        <div className="form-group mb-3">
                                            <a href={`/images/downloadmaster/${formData.image}`} target="_blank" rel="noreferrer noopener">
                                                <img src={`/images/downloadmaster/${formData.image}`} alt="" style={{ width: '100%' }} />
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div className='row'>
                                    ...
                                    <div className="col-3">
                                        <div className="form-group mb-3">
                                            <a href={`/images/downloadmaster/${formData.downloadoption1}`} target="_blank" rel="noreferrer noopener">
                                                <img src={`/images/downloadmaster/${formData.downloadoption1}`} alt="" style={{ width: '100%' }} />
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-3">
                                        <div className="form-group mb-3">
                                            <a href={`/images/downloadmaster/${formData.downloadoption2}`} target="_blank" rel="noreferrer noopener">
                                                <img src={`/images/downloadmaster/${formData.downloadoption2}`} alt="" style={{ width: '100%' }} />
                                            </a>
                                        </div>
                                    </div>
                                </div>
