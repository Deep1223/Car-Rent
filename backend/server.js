...
// ---------------------------------------------------------------------------------------- //
// Multer configuration for file upload
const downloadlinkmasterstorage = multer_1.default.diskStorage({
    destination: function (req, file, cb) {
...
const downloadlinkmasterupload = (0, multer_1.default)({ storage: downloadlinkmasterstorage });
// Endpoint to handle file upload
...
// Endpoint to update data
app.put('/downloadlinkmaster/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log(req.body);
    const id = req.params.id;
    const { title, downloadurl, image, description, downloadimage1, downloadimage2, url1, url2 } = req.body;
    const newtimestamp = new Date();
    ...
    connection.query(SELECT_IMAGE_QUERY, id, (err, imageResults) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        connection.query(UPDATE_USER_QUERY, [title, downloadurl, newimage, description, uniquedownloadimage1, uniquedownloadimage2, url1, url2, newtimestamp, id], (err, results) => __awaiter(void 0, void 0, void 0, function* () {
            if (err) {
                console.error('Error updating data: ' + err);
                res.status(500).send('Error updating data');
                return;
...
const companylogoupload = (0, multer_1.default)({ storage: companylogostorage });
// Endpoint to handle file upload
...
// Endpoint to update data
app.put('/companylogomaster/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const { image, name } = req.body;
    const newtimestamp = new Date();
    ...
    connection.query(SELECT_IMAGE_QUERY, id, (err, imageResults) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        connection.query(UPDATE_USER_QUERY, [newimage, name, newtimestamp, id], (err, results) => __awaiter(void 0, void 0, void 0, function* () {
            if (err) {
                console.error('Error updating data: ' + err);
                res.status(500).send('Error updating data');
                return;
...
// ---------------------------------------------------------------------------------------- //
// Multer configuration for file upload
const testimonialstorage = multer_1.default.diskStorage({
    destination: function (req, file, cb) {
...
const testimonialupload = (0, multer_1.default)({ storage: testimonialstorage });
// Endpoint to handle file upload
...
// Endpoint to update data
app.put('/testimonialmaster/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const { image, name, description, rating, city, country } = req.body;
    const newtimestamp = new Date();
    ...
    connection.query(SELECT_IMAGE_QUERY, id, (err, imageResults) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        connection.query(UPDATE_USER_QUERY, [newimage, name, description, rating, city, country, newtimestamp, id], (err, results) => __awaiter(void 0, void 0, void 0, function* () {
            if (err) {
                console.error('Error updating data: ' + err);
                res.status(500).send('Error updating data');
                return;
...
// ---------------------------------------------------------------------------------------- //
// Multer configuration for file upload
const whychooseusstorage = multer_1.default.diskStorage({
    destination: function (req, file, cb) {
...
const whychooseusupload = (0, multer_1.default)({ storage: whychooseusstorage });
// Endpoint to handle file upload
app.post('/whychooseusupload', whychooseusupload.single('file'), (req, res) => {
    res.status(200).send('File uploaded successfully');
});
// temp img upload start //
const whychooseusdatastorage = multer_1.default.diskStorage({
    destination: function (req, file, cb) {
...
const whychooseusdataupload = (0, multer_1.default)({ storage: whychooseusdatastorage });
...
app.post('/whychooseusdatamaster', (req, res) => {
    ...
    const values = data.map((item) => [item.no, item.subtitle, item.description, item.subimage, timestamp]);
